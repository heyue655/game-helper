...
const { createOrder, listOrders, getOrder, getOrderByNo, getPayUrl, deliverOrder, reviewOrder, complainOrder, getOrderCounts, listMyTasks, closeOrder, getMyEarnings } = require('../controllers/orders')
...
router.get('/:id/pay-url', getPayUrl)
